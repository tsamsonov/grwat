...
tests = grwat::test_variables(total, year = params$year, exclude = params$exclude)
...
grwat::plot_minmonth(total, year = params$year, exclude = params$exclude, locale = params$locale, pagebreak = TRUE)
```
```{r, fig.height=8, fig.width=11, warning=FALSE, include = TRUE, results='asis', echo=FALSE, message=FALSE}
