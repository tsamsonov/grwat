...
```{r, out.width='100%', fig.width = 8, fig.height = 6, dpi = 300}
...
```{r, out.width='100%', fig.width = 8, fig.height = 12, dpi = 300}
methods = c("maxwell",
            "boughton",
            "jakeman",
            "lynehollick",
...
```{r, , out.width='100%', fig.width = 8, dpi = 300, collapse=TRUE, message=FALSE}
...
```{r, , out.width='100%', fig.width = 6, dpi = 300, eval=FALSE}
...
```{r, out.width='100%', fig.width = 8, dpi = 300}
...
```{r, out.width='100%', fig.width = 8, fig.height= 8, dpi = 300}
...
```{r, out.width='100%', fig.width = 8, fig.height= 8, dpi = 300, message=FALSE}
...
```{r, eval = FALSE}
gr_report(sep, vars, output = '/Volumes/Work/_grwat/Spas-Zagorye.html')
```
