...
#' 
#' This function generates a graphical HTML report that summarizes separation of hydrograph, its variables and their statistical properties. See example [report](https://tsamsonov.github.io/grwat/articles/Spas-Zagorye.html) generated by this command for `spas` dataset included in grwat package. 
#'
