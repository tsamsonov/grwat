...
gr_summarize <- function(tab) {
  ...
  tab %>% 
    ...
    summarise(Year1 = min(Year),
              ...
              Q30w = condrollmean(Qin, Qtype == 2, 30),
              date30w1 = Date[condrollmeanidx(Qin, Qtype == 2, 30)],
              date30w2 = date30w1 + 29,
              Q10s = condrollmean(Qin, Qtype == 1, 10),
              date10s1 = Date[condrollmeanidx(Qin, Qtype == 1, 10)],
              date10s2 = date10s1 + 9,
              Q10w = condrollmean(Qin, Qtype == 2, 10),
              date10w1 = Date[condrollmeanidx(Qin, Qtype == 2, 10)],
              date10w2 = date10w1 + 9,
              Q5s = condrollmean(Qin, Qtype == 1, 5),
              date5s1 = Date[condrollmeanidx(Qin, Qtype == 1, 5)],
              date5s2 = date5s1 + 4,
              Q5w = condrollmean(Qin, Qtype == 2, 5),
              date5w1 = Date[condrollmeanidx(Qin, Qtype == 2, 5)],
              date5w2 = date5w1 + 4,
