...
```{r, include=TRUE}
if (params$locale == 'EN') {
  knitr::asis_output("## Discharge matrices")
} else {
...
message(' > Plotting discharge matrices...\n')
grwat::gr_plot_matrix(sep, type = 'value')
grwat::gr_plot_matrix(sep, type = 'season')
grwat::gr_plot_matrix(sep, type = 'component')
```
