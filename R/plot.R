...
#' @param tests `list` of tests for the same variables (generated by [grwat::test_variables()] function). If tests are specified, then they are added to the plot.
