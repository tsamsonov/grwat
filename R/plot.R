...
gr_plot_sep <- function(df, years = NULL, layout = as.matrix(1), 
                        pagebreak = FALSE, prec = FALSE, temp = FALSE, span = 5, locale = 'EN'){
...
#' @param tests `list` of tests for the same variables (generated by [grwat::test_variables()] function).
...
#' @param exclude Integer vector of years to be excluded from plotting.
#' @param tests Tests list for the same variables (generated by [grwat::test_variables()] function)
#' @param layout `matrix` that encodes the order of plotting.
...
#'
#' @param tests `list` of tests generated by [grwat::test_variables()].
#' @param locale Character string locale. Currently only English locale is supported. Defaults to `'EN'`. 
#'
#' @return ggplot2 objects
#' @export
...
#' Plot the autocorrelation function (ACF) for runoff time series
#'
