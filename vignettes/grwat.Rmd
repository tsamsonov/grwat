...
If we are interested more in the shape and relative dimensions of the hydrographs, and do not want the exact Y axis, then we can proceed with ridgeline plots available at __`ggridges`__ package. __grwat__ contains a cnovenient wrapper called `gr_plot_ridge()`:
