...
Reporting functions from grwat package allow you to:
...
- Export all this stuff in a form of a single-file PDF report
...
Plotting discharge parameters is like plotting separation except that you should provide names or numbers of parameters instead of years. Names are quoted, so you do not need to eclose them in quotes. Plotting is made by `plot_parameters()` function:
```{r}
