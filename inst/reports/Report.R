...
grwat::plot_minmonth(total, change_year = 1978, locale = params$locale)

## ---- fig.height=3.8, fig.width=11, warning=FALSE, include = TRUE, results='asis', echo=FALSE, message=FALSE----
...
## ------------------------------------------------------------------------
tests$stable %>% writexl::write_xlsx(paste('pvalues_', params$name, '.xlsx', sep=''))
